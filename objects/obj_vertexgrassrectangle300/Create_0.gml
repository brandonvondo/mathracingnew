...
grass_rect_hor = 250; //Horizontal (x) size of rectangle
grass_rect_ver = 430; //Vertical (y) size of rectangle
//----------------

//General variables
grass_number = 450; //Number of grass sprites inside the room
