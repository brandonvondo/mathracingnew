...
grass_mode = 2; //Grass mode. Explanation inside the documentation (in scripts)

//Mode 1 variables
grass_radius = 100; //Radius around the object for creating the grass
//----------------

//Mode 2 variables (Size of the imaginary rectangle in which the grass is filled)
grass_rect_hor = 1700; //Horizontal (x) size of rectangle
grass_rect_ver = 100; //Vertical (y) size of rectangle
//----------------

//General variables
grass_number = 800; //Number of grass sprites inside the room
