...
grass_rect_hor = 400; //Horizontal (x) size of rectangle
grass_rect_ver = 20; //Vertical (y) size of rectangle
//----------------

//General variables
grass_number = 70; //Number of grass sprites inside the room
