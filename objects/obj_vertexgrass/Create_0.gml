...
//Mode 1 variables
grass_radius = 60; //Radius around the object for creating the grass
//----------------
...
//General variables
grass_number = 50; //Number of grass sprites inside the room
...
grass_speed = .2; //Speed of the grass animation
